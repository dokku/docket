...
- **dokku-http-auth >= 0.14.0**, if your recipe uses the `dokku_http_auth*` tasks.
- **dokku-acl >= 2.0.1**, if your recipe uses the `dokku_acl_*` tasks.
- **dokku-global-cert >= 0.7.0**, if your recipe uses `dokku_certs` with `global: true`.
