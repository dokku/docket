...
// registry - internal/commands/apply.go returned from the listing branch before
...
// the registry move in internal/commands/apply.go. dokku_config declares its whole
