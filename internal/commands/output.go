...
// run-loop in internal/commands/apply.go populates this once per task and hands it
...
// matching the legacy formatter dispatch in internal/commands/apply.go.
...
// matching the legacy formatter dispatch in internal/commands/plan.go.
