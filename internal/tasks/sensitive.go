...
// known after a server probe - the pre-run collection in internal/commands/apply.go and
// internal/commands/plan.go walks task structs, so it cannot see them (e.g. a
